...
// If varA was "5" and varB was 5, it would look like they are similar, but the typeof varA is
// a string and varB is a number, so they would not register as being equal
...
function exercise7(num7) {
  ...
  // --------------------------------------------
      switch (num7) {
        case 1: answer7 = "You won!"; break;
        case 7: answer7 = "You are lucky!"; break;
        case 101: answer7 = "Welcome to coding 101!"; break;
        case 1000000: answer7 = "You are one in a million!"; break;
        default: answer7 = "Thanks for that!"; break;
      }  
  // --------------------------------------------
  // And above here
  // --------------------------------------------
